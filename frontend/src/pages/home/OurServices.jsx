...
const serviceLists = [
  ...
  {
    id: 3,
    title: "Online Catering",
    des: "Explore menu and order with ease using our ordering",
    image: "/images/home/services/icon3.png",
  },
  {
    id: 4,
    title: "Gift Cards",
    des: "Delight your gusts  with our flavours and presentation",
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <p className="my-5 text-secondary leading-[30px]">
              Rooted in passion, we Curate unforgetable dinning expericences and
              offer exceptional services, blending culinary artistry with warm
              hospitality.
            </p>
            <button className="btn  bg-green text-white px-9 py-3 rounded-full">
              Explore
            </button>
          </div>
        </div>
